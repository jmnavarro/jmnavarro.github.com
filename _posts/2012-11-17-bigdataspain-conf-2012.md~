 ...
 *  [Nati Shalom](http://www.linkedin.com/in/natishalom) talked about cloud and how to integrate/migrate our systems from/to different cloud systems. One thing he mentioned was the case of Zynga, where due to astronomical cost to operate their systems (million of dollars) decided to invest in a in-house datacenter and only use cloud based system to support peaks in demand. Controlled costs together with flexibility. Also presented his product "Cloudify", a sort of cloud abstraction layer (quite interesting).
 ...
 *  [Brendan McAdams](www.linkedin.com/in/bwmcadams) gave the funiest talk. Quite educational, talked about map-reduce basics, some phylosophical sides of software development ("Software is eating the world", as he said). He didn't talk about mongoDB (every of us excepted that)
